...
class JobFetcher:
    ...
    def fetch_adzuna(self, *args, **kwargs):
        """Placeholder for Adzuna support in future. Implement similarly and normalize outputs."""
        raise NotImplementedError("Adzuna fetcher not implemented yet")
